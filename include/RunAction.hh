...
public:
  ...
  void FillTree(int cevent, int cpdg, int ctrackID, int cmotherID, double cstartE, double cdE, double cnonIdE,
       double cstartX, double cstartY, double cstartZ, double cendX, double cendY, double cendZ, 
